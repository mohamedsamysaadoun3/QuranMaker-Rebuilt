...
/**
 * Horizontal color picker adapter with pill-shaped color circles.
 * Supports selection state with a white stroke border.
 * Used by ColorsFragment and color-picking fragments.
 * Converted from original Java ColorAdabter (93 lines).
 */
class ColorAdabter(
    var iColorCallback: IColor?,
    private val colors: IntArray?,
    posSelect: Int
) : RecyclerView.Adapter<ColorAdabter.ViewHolder>() {
