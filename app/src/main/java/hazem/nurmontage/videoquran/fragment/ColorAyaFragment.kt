...
/**
 * Fragment for selecting the color and text preset of a Quran aya entity.
 * Includes tab layout for switching between aya and translation color selection.
 * Converted from ColorAyaFragment.java (188 lines).
 */
class ColorAyaFragment() : Fragment() {

    companion object {
        var instance: ColorAyaFragment? = null
    ...
    // Callback interface matching EditEntityFragment.IEditEntityCallback
    ...
    override fun onCreateView(
        ...
        if (iEditEntityCallback != null && entitySelect != null && resourcesRef != null) {
            ...
            recyclerView?.apply {
                ...
                this.adapter = this@ColorAyaFragment.adapter
            }
    ...
    private fun initTab(view: View) {
        ...
        val tabAya = tabLayout.newTab()
        tabAya.text = resourcesRef?.getString(R.string.tab_aya)
        addCustomViewToTab(tabAya)

        val tabTrsl = tabLayout.newTab()
        tabTrsl.text = resourcesRef?.getString(R.string.tv_translation)
