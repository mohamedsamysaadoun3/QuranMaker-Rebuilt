...
/**
 * Fragment for applying transition effects to Bismilah entities on the timeline.
...
class EffectBismilahFragment() : Fragment() {
    ...
    companion object {
        var instance: EffectBismilahFragment? = null
    ...
    interface ITransition {
        fun applyAll(entityBismilahTimeline: EntityBismilahTimeline)
        fun destroy(entityBismilahTimeline: EntityBismilahTimeline)
        fun `in`(type: String, entityBismilahTimeline: EntityBismilahTimeline)
        fun onHideFragment(entityBismilahTimeline: EntityBismilahTimeline)
        fun out(type: String, entityBismilahTimeline: EntityBismilahTimeline)
        fun playing(entityBismilahTimeline: EntityBismilahTimeline)
        fun remove(tabIndex: Int, entityBismilahTimeline: EntityBismilahTimeline)
        fun updateDurationIn(duration: Float, entityBismilahTimeline: EntityBismilahTimeline)
        fun updateDurationOut(duration: Float, entityBismilahTimeline: EntityBismilahTimeline)
    }
    ...
    constructor(
        ...
        this.time = (entityBismilahTimeline.getRect().width() / entityBismilahTimeline.secondInScreen) * 0.5f
    ...
    override fun onCreateView(
        ...
        if (resources != null && iTransition != null) {
            ...
            rv.setDrawingCacheQuality(0x100000) // DRAWING_CACHE_QUALITY_HIGH
    ...
    fun getIndex(list: List<TransitionBismilahAdabters.TransitionItem>, type: String): Int {
    ...
    fun getInTransition(): List<TransitionBismilahAdabters.TransitionItem> {
        return listOf(
            TransitionBismilahAdabters.TransitionItem(
    ...
    private fun getOutTransition(): List<TransitionBismilahAdabters.TransitionItem> {
        return listOf(
            TransitionBismilahAdabters.TransitionItem(
