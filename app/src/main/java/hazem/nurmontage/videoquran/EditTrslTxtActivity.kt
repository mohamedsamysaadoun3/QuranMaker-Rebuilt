...
/**
 * Activity for editing translation text with background color selection.
 * Very similar to [EditS_NameActivity] but simpler — no surah name style options.
 * Allows editing translation text, toggling background, and picking a color.
 */
class EditTrslTxtActivity : BaseActivity() {
    ...
    // ── Style option selection (unused in translation but kept for parity) ─
